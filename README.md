...
attention-relation KD terms. This is still not enough for stronger causal
claims about update direction, because those new traces have not yet been
materialized in completed controlled benchmark rows, and activation int8
saturation is still missing.
...
- [Sequence-classification I2_SR sidecar CPU probe](benchmarks/results/seqcls_i2sr_sidecar_cpu_mnli_128_2026-05-15.md)
