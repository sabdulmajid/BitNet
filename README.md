...
- **BitDistill status:** Qwen2.5 MNLI FP16-SFT is close to the paper anchor
  ...
  These are real task recoveries, but they still trail their FP references by
  paired deltas `-0.060040` and `-0.058486`, respectively.
