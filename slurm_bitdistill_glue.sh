...
TELEMETRY_GRADIENT_COSINES="${TELEMETRY_GRADIENT_COSINES:-0}"
...
echo "TELEMETRY_EVERY_STEPS=$TELEMETRY_EVERY_STEPS TELEMETRY_COMPONENT_GRAD_NORMS=$TELEMETRY_COMPONENT_GRAD_NORMS TELEMETRY_GRADIENT_COSINES=$TELEMETRY_GRADIENT_COSINES TELEMETRY_MAX_ELEMENTS_PER_LAYER=$TELEMETRY_MAX_ELEMENTS_PER_LAYER"
...
TELEMETRY_GEOMETRY_ARGS=(--no-telemetry-gradient-cosines)
if [ "$TELEMETRY_GRADIENT_COSINES" = "1" ]; then
  TELEMETRY_GEOMETRY_ARGS=(--telemetry-gradient-cosines)
fi
