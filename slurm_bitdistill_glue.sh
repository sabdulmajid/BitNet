...
echo "LOGIT_KD_WEIGHT=$LOGIT_KD_WEIGHT ATTENTION_KD_WEIGHT=$ATTENTION_KD_WEIGHT LOGIT_TEMPERATURE=$LOGIT_TEMPERATURE ATTENTION_TEMPERATURE=$ATTENTION_TEMPERATURE"
