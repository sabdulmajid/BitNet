...
python benchmarks/build_evidence_manifest.py \
  ...
  --allow-missing-label bitdistill_postprocess_submission_report \
  --allow-missing-label bitdistill_postprocess_submission_json \
  ...
  --allow-missing-label bitdistill_warmup_finalizer_report \
  --allow-missing-label bitdistill_warmup_finalizer_json \
