...
Generated: `2026-09-04T03:53:38.263815+00:00`
...
| BitDistill reproduction gap | Local BitDistill-style training is improving but has not reproduced paper-level GLUE quality. | MNLI 40.96M 0.616607; 163.84M 0.691187; 327.68M 0.720020; 655.36M 0.729903; latest delta vs FP16 -0.078248 | true | Must frame as a reproduction-gap study until a within-1pt row is reproduced. |
...
| --- | --- | --- | --- | --- |
| Completed 655M Stage-2 downstream MNLI | run_gamma_balanced_downstream | The Stage-2 marginal gain is weak and gamma-60 rebalances updates. Run a matched 10k-step downstream MNLI row with the balanced coefficient before spending more Stage-2 tokens. | Meaningful marginal gain or within-1pt FP recovery gate. | Saturation far below FP, requiring recipe/loss audit instead of broader sweeps. |
| Gamma-60 component-gradient telemetry | gamma60_rebalanced_attention_updates | If gamma-60 rebalances attention/CE updates, run matched downstream MNLI. | Attention-KD gradient no longer dominates CE by the current local threshold. | Attention remains dominant, indicating deeper loss-normalization or recipe mismatch. |
...
| BitDistill reproduction | Current MNLI curve: 40.96M 0.616607, 163.84M 0.691187, 327.68M 0.720020, 655.36M 0.729903; latest delta vs FP16 -0.078248. |
...
| minimum_for_stronger_claim | matched 10k-step gamma-60 MNLI quality run from the 655M checkpoint, replicated within-1pt MNLI recovery row, QNLI/SST2 rows only after MNLI gate, same-artifact task quality and CPU runtime proof |
