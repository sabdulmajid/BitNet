...
| BitDistill paired audit has BitNet baseline rows | pass | rows=3, path=benchmark_results/bitdistill_paired_predictions_2026-05-14.json |  |
...
| evidence manifest has no missing artifacts | pass | path=benchmarks/results/evidence_manifest_2026-05-14.json, artifacts=157, missing=0, missing_labels=[] |  |
