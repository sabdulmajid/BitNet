...
| MoE/Kimi retrofit and CPU runtime support | unsupported | Kimi artifacts=0; Kimi source matches=0; tiny Qwen2MoE FP16 fixture passed=True; fixture arch=qwen2moe; fixture RSS MiB=105.09765625; failed MoE gates=3/7; TL2 MoE runtime ready=False; TL2 expert byte underreport=0 | Treat as separate research milestone. | No Kimi-specific mapping, trained Qwen2MoE/Kimi quality artifact, ternary MoE runtime artifact, TL2 3D expert runtime support, router distillation, quality benchmark, or expert-locality benchmark exists; the tiny Qwen2MoE fixture only proves FP16 converter/runtime plumbing. |
