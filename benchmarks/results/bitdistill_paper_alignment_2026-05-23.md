...
Generated: `2026-09-04T03:53:38.206680+00:00`
...
| Baselines | FP16-SFT, BitNet-SFT, and BitDistill. | MNLI FP16-SFT 0.808151; BitNet-SFT best 0.628935; BitDistill latest 0.729903. | mnli_present | BitDistill is still below FP; QNLI/SST2 baselines should wait for MNLI recovery gate. |
...
| Stage-2 token budget | 10B continued-pretraining tokens. | Completed controlled row 655,360,000 tokens (6.5536% of paper); active gate targets 655,360,000 tokens (6.5536% of paper). | under_budget_active_extension_running | Current non-reproduction cannot disprove paper-scale BitDistill. |
...
| Attention-relation coefficient | Classification uses large attention-KD coefficient; exact meaning depends on reductions. | Paper-gamma local telemetry showed attention/CE imbalance; gamma status is gamma60_rebalanced_attention_updates. | normalization_not_proven_equivalent | Copying gamma numerically is not enough unless reductions match. |
...
| Success criterion | BitDistill comparable to FP16-SFT on downstream tasks. | Latest completed MNLI delta vs FP16 is -0.078248; configured recovery gate is -0.010000. | not_met | No public claim of paper-level reproduction. |
