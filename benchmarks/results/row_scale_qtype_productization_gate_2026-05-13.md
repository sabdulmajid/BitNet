...
Scenario: `I2_SR active promoted runtime`.

Note: Generated after promoting the prepared I2_SR llama.cpp submodule branch to https://github.com/sabdulmajid/llama.cpp and applying the BitNet root runtime support in this superproject.
...
- Archived legacy row-scale `I2_S` patch overloads existing `I2_S`: `True`.
