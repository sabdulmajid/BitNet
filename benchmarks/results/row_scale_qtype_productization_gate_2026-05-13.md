...
| direct writer emits stable row-scale qtype | fail | benchmarks/convert_static_ternary_to_i2s_gguf.py | Direct writer only emits existing I2_S numeric type IDs/prototype layout. |
...
- Direct writer emits stable row-scale qtype: `False`.
