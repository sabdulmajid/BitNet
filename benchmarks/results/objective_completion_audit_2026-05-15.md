...
| Produce side-by-side comparison, evidence manifest, prune plan, and honest novelty/product verdict | complete | manifest artifacts=197, missing=0; coverage=True checks=50; publishable ledger scopes negative result plus recovery path |  |
