...
| Paper-level BitDistill is reproduced | not proven | FP16-SFT MNLI is close to paper (`0.807641` vs `0.799100`), but BitNet-SFT is weak (`0.487621` default; best completed 1000-step LR row `0.523892` vs paper `0.608000`). |
...
| BitNet-SFT best completed 1000-step LR row | `0.523892` | `0.608000` |
...
- A 1000-step LR sweep improves the best short row to `0.523892`, but the row
  covers only `16,000` optimizer examples, or `0.040743` MNLI epochs.
