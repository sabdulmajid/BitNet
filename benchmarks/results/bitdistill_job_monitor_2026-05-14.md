...
Job table: `/mnt/slurm_nfs/a6abdulm/projects/BitNet/benchmark_results/bitdistill_longwarmup_downstream_20260514_163342.tsv`.

## Stage-2 Warm-Up

| log | step | max steps | progress | latest CE | effective tokens | target tokens | ETA |
| --- | --- | --- | --- | --- | --- | --- | --- |
| /mnt/slurm_nfs/a6abdulm/projects/BitNet/logs/bitdistill-glue-9894.out | 710 | 20000 | 0.035500 | 5.206073 | 5816320 | 163840000 | 9.76h |
