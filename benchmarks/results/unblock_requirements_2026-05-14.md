# Unblock Requirements Audit, 2026-05-14
...
Next required input: Provide a licensed trained Kimi or Qwen2MoE checkpoint/tokenizer artifact plus its FP and quantized baselines. The tiny random Qwen2MoE fixture is not a substitute.
...
| Local trained Kimi/Qwen2MoE model artifact | missing | trained_artifacts=0; tiny_fixture_passed=True; all_moe_named_artifacts=4 | Provide a licensed trained Kimi or Qwen2MoE checkpoint/tokenizer artifact plus its FP and quantized baselines. The tiny random Qwen2MoE fixture is not a substitute. |
...
| MoE quality/locality benchmark artifacts | missing | failed_moe_gates=3; trained_artifacts=0; tiny_fixture_passed=True | Run router accuracy, expert locality, quality, throughput, and RSS benchmarks after model and packing support exist. |
