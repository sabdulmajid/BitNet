...
| Paper-level BitDistill reproduction | not_proven | Keep labeled as paper-inspired until full controlled rows close the FP gap. | controlled rows complete=1/3; passed FP recovery=0; best controlled accuracy=0.691187; best paired delta vs FP=-0.116964. |  |
