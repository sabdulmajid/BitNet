...
| Row-scale ternary GGUF keeps a memory advantage over FP16 at long context but not over Q4_K_M | supported | `benchmarks/results/gguf_context_scaling_2026-05-05.md`; `benchmarks/results/i2sr_rss_2026-05-13.md`; `benchmark_results/evidence_audit/qwen15b_context_scaling_rss.md` | Qwen2.5-1.5B row-scale dense-`lm_head`; `I2_S`/`TQ2_0` contexts 512/2048/8192/32768; fixed `I2_SR` checked at context 512 |
