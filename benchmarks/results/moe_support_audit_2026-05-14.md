...
| BitNet converter Qwen2MoE registration | utils/convert-hf-to-gguf-bitnet.py | present | BitNet converter explicitly registers Qwen2MoE and merges expert tensors | `@Model.register("Qwen2MoeForCausalLM")`@1002, `MODEL_ARCH.QWEN2MOE`@1004, `torch.stack(datas, dim=0)`@935 |
