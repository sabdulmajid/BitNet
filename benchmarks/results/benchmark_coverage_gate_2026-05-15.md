...
| Sequence-classification runtime gap is explicitly blocked | pass | status=blocked_by_classifier_runtime, seqcls=15, seqcls_exportable=0, causal_exportable=6, exports=6 |  |
...
| evidence manifest has no missing artifacts | pass | path=benchmarks/results/evidence_manifest_2026-05-15.json, artifacts=217, missing=0, missing_labels=[] |  |
