...
| mnli | tensor-warmup tensor gamma100 | tensor_warmup_gamma100 | false | - | - | 9815 | fail_or_pending | - | 0.807641 | - | - | fail_or_pending | checkpoints/bitdistill-glue-seqcls-longwarmup/Qwen-Qwen2.5-0.5B/mnli/bitdistill-longwarmup-tensor-layer-8/metrics.json |
| mnli | tensor-warmup row gamma100 | tensor_warmup_row_gamma100 | false | - | - | 9815 | fail_or_pending | - | 0.807641 | - | - | fail_or_pending | checkpoints/bitdistill-glue-seqcls-longwarmup/Qwen-Qwen2.5-0.5B/mnli/bitdistill-longwarmup-row-layer-8/metrics.json |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| mnli | row_warmup_gamma100_minus_tensor_warmup_tensor_gamma100 | - | - | - | - | - | - |
| mnli | row_warmup_gamma100_minus_tensor_warmup_row_gamma100 | - | - | - | - | - | - |
