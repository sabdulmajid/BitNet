...
| MoE/Kimi retrofit and CPU runtime support | unsupported | Kimi artifacts=0; Kimi source matches=0; failed MoE gates=4/6; TL2 MoE runtime ready=False; TL2 expert byte underreport=69632 | Treat as separate research milestone. | No Kimi/Qwen2MoE BitNet converter mapping, TL2 3D expert packing/runtime support, router distillation, quality benchmark, or expert-locality benchmark exists; direct I2_S/I2_SR expert packing is only synthetic so far. |
