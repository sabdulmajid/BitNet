...
| MoE/Kimi retrofit and CPU runtime support | unsupported | Kimi artifacts=0; Kimi source matches=2; failed MoE gates=5/6 | Treat as separate research milestone. | No Kimi/Qwen2MoE BitNet converter mapping, 3D expert TL2/I2_SR packing support, router distillation, quality benchmark, or expert-locality benchmark exists. |
