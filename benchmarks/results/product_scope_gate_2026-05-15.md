...
| BitDistill task-specific packed ternary runtime support | unsupported | causal packed-ternary gate passed=False; complete rows=0/6; gate=benchmark_results/bitdistill_i2sr_export_gate_2026-05-15.json | Only causal prompt-scoring BitDistill checkpoints can use this packed path; tensor baselines use I2_S, row-scale novelty runs use I2_SR, and sequence-classification heads remain PyTorch-only unless runtime support is added. | missing export row; missing export summary benchmark_results/bitdistill-causal-longwarmup-i2sr-2026-05-15/export_summary.json; missing memory summary benchmark_results/bitdistill-causal-longwarmup-i2sr-2026-05-15/memory/summary.json; missing suite summary benchmark_results/bitdistill-causal-longwarmup-i2sr-2026-05-15/gguf_suite/summary.json |
