...
Next engineering gate: Finish the LR/head-init search, paired-trace, and CPU-quality dependency chain, then validate row-scale I2_SR export/CPU evidence and keep MoE/Kimi as a separate milestone.
