...
| row continued-pretrain writes metrics | pass | benchmark_results/bitdistill-smoke-contract-2026-05-14/continued_pretrain_row/metrics.json |  |
...
| continued-pretrain tensor GGUF export maps SubLN | pass | packed=14, outfile=benchmark_results/bitdistill-smoke-contract-2026-05-14/continued_pretrain_i2s_smoke.gguf |  |
| row continued-pretrain I2_SR GGUF export maps SubLN and row scales | pass | row_packed=14, outfile=benchmark_results/bitdistill-smoke-contract-2026-05-14/continued_pretrain_row_i2sr_smoke.gguf |  |
...
| task-sft logits KD is finite | pass | weighted_logit_kd=0.009390264749526978 |  |
| task-sft attention KD is finite | pass | weighted_attention_kd=3.958871841430664 |  |
...
| row task-sft logits KD is finite | pass | weighted_logit_kd=0.009045470505952835 |  |
| row task-sft attention KD is finite | pass | weighted_attention_kd=3.935344934463501 |  |
