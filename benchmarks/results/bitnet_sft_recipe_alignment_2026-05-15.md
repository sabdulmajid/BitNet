...
- Best completed budget-sweep row: `0.574733`.
...
| Best completed budget row reaches paper anchor | fail | best_completed=0.574733, steps=3000, lr=2e-5 | Longer 3000/10000-step rows are needed to distinguish undertraining from equation mismatch. |
