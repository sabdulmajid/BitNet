...
Note: Generated by benchmarks/run_i2sr_active_patch_gate.py after applying patches/llama-i2sr-row-scale-qtype.patch to the clean active source tree; the script reverses the patch before exiting.
