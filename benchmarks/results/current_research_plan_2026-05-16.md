...
The completed Qwen3 MNLI branch is a useful caution: row-scale is not
monotonically better. On Qwen3-0.6B-Base MNLI, tensor BitDistill is `0.723484`
while row BitDistill is `0.696179`. Row-scale remains a systems/runtime
