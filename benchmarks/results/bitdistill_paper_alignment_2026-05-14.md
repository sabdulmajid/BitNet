...
| Stage-3 attention KD | single-layer Q/K/V relation KD, gamma 1e5 for classification | single-layer Q/K/V KD implemented; completed runs gamma 100; paper-gamma branch pending | pending | This was the main newly found hyperparameter gap. |
...
| active effective tokens | 15073280 |
| active effective / paper | 0.001507 |
| latest step | 1840 |
| max steps | 20000 |
