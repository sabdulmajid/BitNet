# Tiny Qwen2MoE Runtime Fixture, 2026-05-15
...
| Peak RSS measured | yes | 105.109375 MiB |
| Qwen2MoE metadata present | yes | experts=2; used=1 |

## Runtime Snapshot

Architecture: `qwen2moe`; params: `19.48` M; CPU buffer: `37.16` MiB; peak RSS: `105.109375` MiB; prompt: `9633.91` tok/s; decode: `2175.26` tok/s.
