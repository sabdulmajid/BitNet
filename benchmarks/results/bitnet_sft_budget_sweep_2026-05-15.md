...
Best completed sweep row is accuracy `0.457056` at steps=`1000`, lr=`5e-6`. The paper BitNet-SFT anchor remains `0.608000`, so the remaining gap is `0.150944`.
