...
RUNS = [
    ...
    RunRef("BitDistill longwarmup tensor gamma100", "checkpoints/bitdistill-glue-seqcls-longwarmup", "{task}/bitdistill-longwarmup-tensor-layer-8", "sequence_classification", "completed_local_candidate"),
    RunRef("BitDistill longwarmup tensor paper gamma", "checkpoints/bitdistill-glue-seqcls-longwarmup-papergamma", "{task}/bitdistill-longwarmup-tensor-layer-8", "sequence_classification", "completed_paper_candidate"),
    RunRef("BitDistill longwarmup row paper gamma", "checkpoints/bitdistill-glue-seqcls-longwarmup-papergamma-row", "{task}/bitdistill-longwarmup-row-layer-8", "sequence_classification", "completed_paper_row_candidate"),
